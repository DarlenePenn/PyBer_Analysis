...
### The purpose of the analysis was to create a DataFrame that summarizes the ride-sharing data of PyBer by city type (Urban, Suburban, and Rural). Then visualizea multiple-line graph that shows the total weekly fares for each city type. This allows us to see the sum of weekly fares over time for each city type.
